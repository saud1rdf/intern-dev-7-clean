...
const components = {
  ...
  h2: (props: React.HTMLAttributes<HTMLHeadingElement>) => {
    ...
    return (
      <h2 
        id={slug} 
        className="mt-10 mb-4 scroll-mt-24 text-2xl font-bold text-gray-900 dark:text-gray-100 border-b pb-2" 
        {...props} 
      />
    );
  },
    ...
    if (isExternal) {
      return (
        <a 
          ...
          className="text-blue-600 hover:text-blue-800 dark:text-blue-400 underline decoration-blue-300 underline-offset-2" 
        />
      );
    }
    return (
